...
import vn.edu.hust.formtest.adapters.AddressAdapter
...
import vn.edu.hust.formtest.util.HorizontalItemDecoration
import vn.edu.hust.formtest.util.Resource
import vn.edu.hust.formtest.viewmodel.BillingViewModel
import vn.edu.hust.formtest.viewmodel.OrderViewModel
import vn.edu.hust.graduationproject.R
import vn.edu.hust.graduationproject.databinding.FragmentBillingBinding
            ...
            orderViewModel.order.collectLatest {
                when(it){
                    ...
                    is Resource.Success ->{
                        ...
                        findNavController().navigateUp()
                        Snackbar.make(requireView(),"Your order has been placed", Snackbar.LENGTH_LONG).show()
                    }
                    is Resource.Error ->{
                        binding.buttonPlaceOrder.revertAnimation()
                        Toast.makeText(requireContext(), "Error ${it.message}", Toast.LENGTH_SHORT).show()
